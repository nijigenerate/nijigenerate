...
public import nijigenerate.ver;
public import nijigenerate.atlas;
public import nijigenerate.io;
...
class Project {
    ...
    */
    ...
    struct ParamEvent {
        mixin Signal!(Parameter);
    }
    struct EditModeEvent {
        mixin Signal!(EditMode);
    }

    struct AnimationEvent {
        mixin Signal!AnimationPlaybackRef;
    }

    struct CameraFocusEvent {
        mixin Signal!(float, vec2);
    }
    ...
    AnimationEvent AnimationChanged;

    CameraFocusEvent CameraFocused;
}

package(nijigenerate) {
    void function(Project)[] newProjectCallbacks;
...
//    import nijigenerate.viewport : incViewportReset;
    ...
    foreach (callback; newProjectCallbacks) {
...
//    import nijigenerate.viewport : incViewportTargetZoom, incViewportTargetPosition;
...
//    import nijigenerate.viewport : incViewportTargetZoom, incViewportTargetPosition;
    ...
    activeProject.CameraFocused.emit(clamp(factor*0.90, 0.1, 2.5), vec2(position.x, position.y));
}
