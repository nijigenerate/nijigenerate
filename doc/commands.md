...
| `CaptureLiveScreenshotCommand` | [puppet/view.d](/Users/seagetch/src/nijigenerate/nijigenerate/source/nijigenerate/commands/puppet/view.d) | no | default | false | - | - | - | - | tool | Returns MCP image/png content; accepts optional overlayObjects for bounds/mesh overlays |
...
| `DefineMeshCommand` | [vertex/define_mesh.d](/Users/seagetch/src/nijigenerate/nijigenerate/source/nijigenerate/commands/vertex/define_mesh.d) | no | custom | false | - | - | - | structural-edit | tool | Drawable only; requires vertices and triangle indices |
| `DefineVerticesCommand` | [vertex/define_mesh.d](/Users/seagetch/src/nijigenerate/nijigenerate/source/nijigenerate/commands/vertex/define_mesh.d) | no | custom | false | - | - | - | structural-edit | tool | Non-Drawable Deformable only; sets control vertices without triangle topology; GridDeformer requires rectangular grid vertices |
| `DefineGridCommand` | [vertex/define_mesh.d](/Users/seagetch/src/nijigenerate/nijigenerate/source/nijigenerate/commands/vertex/define_mesh.d) | no | custom | false | - | - | - | structural-edit | tool | GridDeformer only; defines grid vertices from axisX and axisY |
