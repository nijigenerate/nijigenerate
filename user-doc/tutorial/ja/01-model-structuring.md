...
- 広い面（顔・後頭部・胴・前髪・胸）には GridDeformer を 1 個ずつ入れる。特に前髪が複数ある場合はまとめて一つのGridDeformerで覆うのが良い。
...
- 右目・左目・口・耳の各 Part は顔（`Face` の **Part**）の子（目・口ともに DynamicComposite でまとめるのを推奨）
